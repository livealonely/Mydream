...
<!-- 添加员工 -->
<div id="member_memberlist_add_dialog" class="easyui-dialog" title="添加订单" data-options="modal:true,closed:true,iconCls:'icons-application-application_add',buttons:[{text:'确定',iconCls:'icons-other-tick',handler:function(){$('#member_memberlist_add_dialog_form').submit();}},{text:'取消',iconCls:'icons-arrow-cross',handler:function(){$('#member_memberlist_add_dialog').dialog('close');}}]" style="width:480px;height:300px;"></div>
...
var Member_memberlist_datagrid_toolbar = [
	{ text: '添加订单', iconCls: 'icons-arrow-add', handler: adminMemberAdd },
...
function adminMemberAdd(){
	$('#member_memberlist_add_dialog').dialog({href:'<?php echo U('Order/memberAdd');?>'});
...
</script><taglib name="Admin\TagLib\EasyUI" />