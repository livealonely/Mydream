...
<table>
	...
	<tr>
		<td>部门：</td>
		<td><input id="admin_memberlist_add_dialog_form_department" type="text" name="info[department]" style="width:180px;height:22px" /></td>
		<td><div id="admin_memberlist_add_dialog_form_departmentTip"></div></td>
	</tr>
	<tr>
		<td>职位：</td>
	...
	<tr>
		<td>微信：</td>
		<td><input id="admin_memberlist_add_dialog_form_wechat" type="text" name="info[realname]" style="width:180px;height:22px" /></td>
