...
$(function(){
	...
	$("#admin_rolelist_add_dialog_form_name").formValidator({onShow:"请输入部门名称",onFocus:"部门名称不能为空"}).inputValidator({min:1,max:999,onError:"部门名称不能为空"}).ajaxValidator({
		type : "post",
		url : "<?php echo U('Member/public_checkRoleName');?>",
		data : {rolename:function(){return $("#admin_rolelist_add_dialog_form_name").val()} },
		datatype : "json",
		async:'false',
...
<table cellspacing="6" width="100%">
	<tr>
		<td width="80">部门名称：</td>
		<td><input id="admin_rolelist_add_dialog_form_name" type="text" name="info[rolename]" style="width:180px;height:22px" /></td>
